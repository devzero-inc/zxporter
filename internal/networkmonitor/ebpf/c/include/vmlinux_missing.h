...
//  as a temporary workaround for failing builds, use the default value of
//  PAGE_SHIFT
#define PAGE_SHIFT 12
#define PAGE_SIZE (_AC(1, UL) << PAGE_SHIFT)
...
// this can also be PAGE_SHIFT if (MIN_THREAD_SHIFT < PAGE_SHIFT) however here
// 14 > 12 so we choose MIN_THREAD_SHIFT
...
#define get_node_addr(array, index)                                            \
  __get_node_addr(array, typeof(*array), index)
