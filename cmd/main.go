...
func main() {
	...
	apiExtensionClient, err := apiextensionsclientset.NewForConfig(ctrl.GetConfigOrDie())
	if err != nil {
	...
	if err = (&controller.CollectionPolicyReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "CollectionPolicy")
		os.Exit(1)
	}
