...
# apps.devzero.io/resource-adjustment-operator-bundle:$VERSION and apps.devzero.io/resource-adjustment-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= apps.devzero.io/resource-adjustment-operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name resource-adjustment-operator-builder
	$(CONTAINER_TOOL) buildx use resource-adjustment-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm resource-adjustment-operator-builder
	rm Dockerfile.cross
