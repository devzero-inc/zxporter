...
// TelemetryMetricType represents the type of a telemetry metric
type TelemetryMetricType int32

const (
	TelemetryMetricType_TELEMETRY_METRIC_TYPE_UNSPECIFIED TelemetryMetricType = 0
	TelemetryMetricType_TELEMETRY_METRIC_TYPE_GAUGE       TelemetryMetricType = 1
	TelemetryMetricType_TELEMETRY_METRIC_TYPE_COUNTER     TelemetryMetricType = 2
	TelemetryMetricType_TELEMETRY_METRIC_TYPE_HISTOGRAM   TelemetryMetricType = 3
)

// Enum value maps for TelemetryMetricType.
var (
	TelemetryMetricType_name = map[int32]string{
		0: "TELEMETRY_METRIC_TYPE_UNSPECIFIED",
		1: "TELEMETRY_METRIC_TYPE_GAUGE",
		2: "TELEMETRY_METRIC_TYPE_COUNTER",
		3: "TELEMETRY_METRIC_TYPE_HISTOGRAM",
	}
	TelemetryMetricType_value = map[string]int32{
		"TELEMETRY_METRIC_TYPE_UNSPECIFIED": 0,
		"TELEMETRY_METRIC_TYPE_GAUGE":       1,
		"TELEMETRY_METRIC_TYPE_COUNTER":     2,
		"TELEMETRY_METRIC_TYPE_HISTOGRAM":   3,
	}
)

func (x TelemetryMetricType) Enum() *TelemetryMetricType {
	p := new(TelemetryMetricType)
	*p = x
	return p
}

func (x TelemetryMetricType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TelemetryMetricType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_metrics_collector_proto_enumTypes[2].Descriptor()
}

func (TelemetryMetricType) Type() protoreflect.EnumType {
	return &file_api_v1_metrics_collector_proto_enumTypes[2]
}

func (x TelemetryMetricType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TelemetryMetricType.Descriptor instead.
func (TelemetryMetricType) EnumDescriptor() ([]byte, []int) {
...
// Label represents a key-value pair used to tag metrics
type Label struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
// GaugeValue represents a single gauge value
...
// CounterValue represents a single counter value
...
// HistogramValue represents a histogram with its buckets and sum
...
// TelemetryMetric represents a single telemetry metric with its metadata
type TelemetryMetric struct {
	...
	// Type of the metric
	Type TelemetryMetricType `protobuf:"varint,5,opt,name=type,proto3,enum=api.v1.TelemetryMetricType" json:"type,omitempty"`
	// Only one of these fields will be set based on the type
	//
	// Types that are assignable to Value:
	//
	//	*TelemetryMetric_Gauge
	//	*TelemetryMetric_Counter
	//	*TelemetryMetric_Histogram
	Value isTelemetryMetric_Value `protobuf_oneof:"value"`
}
...
func (x *TelemetryMetric) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *TelemetryMetric) GetHelp() string {
	if x != nil {
		return x.Help
	}
	return ""
...
func (x *TelemetryMetric) GetLabels() []*Label {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (x *TelemetryMetric) GetType() TelemetryMetricType {
	if x != nil {
		return x.Type
	}
	return TelemetryMetricType_TELEMETRY_METRIC_TYPE_UNSPECIFIED
}

func (m *TelemetryMetric) GetValue() isTelemetryMetric_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (x *TelemetryMetric) GetGauge() *GaugeValue {
	if x, ok := x.GetValue().(*TelemetryMetric_Gauge); ok {
		return x.Gauge
	}
	return nil
}

func (x *TelemetryMetric) GetCounter() *CounterValue {
	if x, ok := x.GetValue().(*TelemetryMetric_Counter); ok {
		return x.Counter
	}
	return nil
}

func (x *TelemetryMetric) GetHistogram() *HistogramValue {
	if x, ok := x.GetValue().(*TelemetryMetric_Histogram); ok {
		return x.Histogram
	}
	return nil
}

type isTelemetryMetric_Value interface {
	isTelemetryMetric_Value()
}

type TelemetryMetric_Gauge struct {
	Gauge *GaugeValue `protobuf:"bytes,6,opt,name=gauge,proto3,oneof"`
}

type TelemetryMetric_Counter struct {
	Counter *CounterValue `protobuf:"bytes,7,opt,name=counter,proto3,oneof"`
}

type TelemetryMetric_Histogram struct {
	Histogram *HistogramValue `protobuf:"bytes,8,opt,name=histogram,proto3,oneof"`
}

func (*TelemetryMetric_Gauge) isTelemetryMetric_Value() {}

func (*TelemetryMetric_Counter) isTelemetryMetric_Value() {}

func (*TelemetryMetric_Histogram) isTelemetryMetric_Value() {}
...
type SendTelemetryMetricsRequest struct {
	...
	Metrics []*TelemetryMetric `protobuf:"bytes,2,rep,name=metrics,proto3" json:"metrics,omitempty"`
}
...
func (x *SendTelemetryMetricsRequest) GetMetrics() []*TelemetryMetric {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_api_v1_metrics_collector_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf4, 0x01, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x6f,
	...
	0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	0x31, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x09, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2b, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x12, 0x39, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	...
	0x52, 0x0c, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0xb3,
	0x02, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x39, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x61, 0x6d, 0x49, 0x64, 0x22, 0x86, 0x01, 0x0a, 0x18, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x32, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x65, 0x61, 0x6d, 0x49, 0x64, 0x22, 0x80, 0x01,
	0x0a, 0x14, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65,
	...
	0x22, 0xae, 0x01, 0x0a, 0x19, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39,
	...
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x27, 0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x63,
	...
	,
	...
	0x04, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x6b, 0x0a, 0x0e, 0x48, 0x69, 0x73, 0x74,
	0x6f, 0x67, 0x72, 0x61, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x31, 0x0a, 0x07, 0x62, 0x75,
	0x63, 0x6b, 0x65, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x42, 0x75,
	0x63, 0x6b, 0x65, 0x74, 0x52, 0x07, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x12, 0x10, 0x0a,
	...
	,
	...
	0x12, 0x31, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x6c, 0x65, 0x6d,
	0x65, 0x74, 0x72, 0x79, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x52, 0x07, 0x6d, 0x65, 0x74, 0x72,
	0x69, 0x63, 0x73, 0x22, 0x66, 0x0a, 0x1c, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x65, 0x6c, 0x65, 0x6d,
	...
	0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x70, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x82, 0x02, 0x0a, 0x09,
	...
	0x2a, 0xe6, 0x0a, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70,
	...
	,
...
var file_api_v1_metrics_collector_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_v1_metrics_collector_proto_goTypes = []interface{}{
	...
	(TelemetryMetricType)(0),             // 2: api.v1.TelemetryMetricType
	...
	(*SendResourceResponse)(nil),         // 6: api.v1.SendResourceResponse
	(*SendResourceBatchResponse)(nil),    // 7: api.v1.SendResourceBatchResponse
	(*Label)(nil),                        // 8: api.v1.Label
	(*GaugeValue)(nil),                   // 9: api.v1.GaugeValue
	(*CounterValue)(nil),                 // 10: api.v1.CounterValue
	(*HistogramBucket)(nil),              // 11: api.v1.HistogramBucket
	(*HistogramValue)(nil),               // 12: api.v1.HistogramValue
	(*TelemetryMetric)(nil),              // 13: api.v1.TelemetryMetric
	(*SendTelemetryMetricsRequest)(nil),  // 14: api.v1.SendTelemetryMetricsRequest
	(*SendTelemetryMetricsResponse)(nil), // 15: api.v1.SendTelemetryMetricsResponse
	(*timestamppb.Timestamp)(nil),        // 16: google.protobuf.Timestamp
	(*structpb.Struct)(nil),              // 17: google.protobuf.Struct
}
var file_api_v1_metrics_collector_proto_depIdxs = []int32{
	16, // 0: api.v1.ResourceItem.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 1: api.v1.ResourceItem.event_type:type_name -> api.v1.EventType
	17, // 2: api.v1.ResourceItem.data:type_name -> google.protobuf.Struct
	...
	16, // 5: api.v1.SendResourceRequest.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 6: api.v1.SendResourceRequest.event_type:type_name -> api.v1.EventType
	17, // 7: api.v1.SendResourceRequest.data:type_name -> google.protobuf.Struct
	...
	11, // 11: api.v1.HistogramValue.buckets:type_name -> api.v1.HistogramBucket
	8,  // 12: api.v1.TelemetryMetric.labels:type_name -> api.v1.Label
	16, // 13: api.v1.TelemetryMetric.timestamp:type_name -> google.protobuf.Timestamp
	2,  // 14: api.v1.TelemetryMetric.type:type_name -> api.v1.TelemetryMetricType
	9,  // 15: api.v1.TelemetryMetric.gauge:type_name -> api.v1.GaugeValue
	10, // 16: api.v1.TelemetryMetric.counter:type_name -> api.v1.CounterValue
	12, // 17: api.v1.TelemetryMetric.histogram:type_name -> api.v1.HistogramValue
	13, // 18: api.v1.SendTelemetryMetricsRequest.metrics:type_name -> api.v1.TelemetryMetric
	4,  // 19: api.v1.MetricsCollectorService.SendResource:input_type -> api.v1.SendResourceRequest
	5,  // 20: api.v1.MetricsCollectorService.SendResourceBatch:input_type -> api.v1.SendResourceBatchRequest
	14, // 21: api.v1.MetricsCollectorService.SendTelemetryMetrics:input_type -> api.v1.SendTelemetryMetricsRequest
	6,  // 22: api.v1.MetricsCollectorService.SendResource:output_type -> api.v1.SendResourceResponse
	7,  // 23: api.v1.MetricsCollectorService.SendResourceBatch:output_type -> api.v1.SendResourceBatchResponse
	15, // 24: api.v1.MetricsCollectorService.SendTelemetryMetrics:output_type -> api.v1.SendTelemetryMetricsResponse
...
func file_api_v1_metrics_collector_proto_init() {
	...
	file_api_v1_metrics_collector_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*TelemetryMetric_Gauge)(nil),
		(*TelemetryMetric_Counter)(nil),
		(*TelemetryMetric_Histogram)(nil),
	}
	type x struct{}
