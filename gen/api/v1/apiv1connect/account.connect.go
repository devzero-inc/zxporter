...
const (
	...
	// RegisterUser RPC.
	AccountServiceRegisterUserProcedure = "/api.v1.AccountService/RegisterUser"
)

// AccountServiceClient is a client for the api.v1.AccountService service.
type AccountServiceClient interface {
	// RegisterUser registers a new user to a team.
...
// RegisterUser calls api.v1.AccountService.RegisterUser.
...
func (UnimplementedAccountServiceHandler) RegisterUser(context.Context, *connect.Request[v1.RegisterUserRequest]) (*connect.Response[v1.RegisterUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AccountService.RegisterUser is not implemented"))
}
