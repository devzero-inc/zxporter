...
const (
	AccountService_RegisterUser_FullMethodName = "/api.v1.AccountService/RegisterUser"
)
...
func (c *accountServiceClient) RegisterUser(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*RegisterUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountService_RegisterUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
